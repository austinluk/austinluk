    ...
    <>
      ...
      <div className="page">
        ...
        <div className="content" style={{ paddingTop: '6rem' }}>
          ...
          <section>
            <h1 className="name fade-up fade-up-1" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)' }}>
              About Austin Luk
            </h1>

            <div className="fade-up fade-up-2" style={{ marginTop: '2rem' }}>
              <p className="bio" style={{ marginBottom: '1.5rem' }}>
                I&apos;m Austin Luk, a third-year Computer Science student at the University of British Columbia in Vancouver, BC.
                I&apos;m passionate about building software that solves real problems — from AI-powered teaching assistants to automation bots that connect people.
              </p>
              <p className="bio" style={{ marginBottom: '1.5rem' }}>
                My interests span full-stack development, machine learning, and developer tools. I enjoy taking an idea from zero to production and learning
                whatever&apos;s needed along the way.
              </p>
              <p className="bio" style={{ marginBottom: '1.5rem' }}>
                Outside of coding, you&apos;ll find me playing basketball, exploring Vancouver&apos;s trails, or tinkering with side projects.
              </p>
            </div>
          </section>
