      ...
      <div className="main-container">
        ...
        <section className="hero-section">
          ...
          <div className="fade-in-delay-2">
            <p className="hero-bio">
              ...
              . Interested in full-stack development, AI/ML, and building
              products that make a difference.
            </p>
            <p className="hero-bio">
              When I&apos;m not coding, you can find me exploring Vancouver,
              playing basketball, or working on side projects.
            </p>
          </div>
          ...
          <div className="social-row fade-in-delay-3">
            ...
            <a href="mailto:austin.luk@student.ubc.ca" className="social-link">
              Email
            </a>
          </div>
        </section>
        ...
        <footer className="site-footer">
          <p className="footer-text">
            &copy; {new Date().getFullYear()} Austin Luk
          </p>
        </footer>
      </div>
    </>
